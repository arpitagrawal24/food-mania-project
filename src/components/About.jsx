...
const About = () => {
    return (
        <div className="bg-[#5D9C59] p-6 h-[500px]">
            <div>
                <h1 class="text-4xl font-bold">About Us</h1>

                <p class="mt-4">Welcome to Food Mania, your go-to destination for delicious food delivered right to your doorstep.
                    We are passionate about connecting food lovers with their favorite meals from the best restaurants in town.</p>

                <p class="mt-4">At Food Mania, we believe that good food should be accessible to everyone, whether you're craving a
                ...
                <p class="mt-4">What sets us apart is our commitment to quality and convenience. We partner with top-rated
                ...
                <p class="mt-4">Whether you're planning a family dinner, a gathering with friends, or a quick lunch at work,
                ...
                <p class="mt-4">We value your feedback and strive to continuously improve our services.
                    Your satisfaction is our top priority, and we're always here to assist you
                    with any questions or concerns you may have.</p>

                <p class="mt-4">Thank you for choosing Food Mania. Get ready to embark on a culinary journey
